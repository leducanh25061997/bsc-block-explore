...
const Sidebar: React.FC<SidebarProps> = ({ activeTab, onTabChange }) => {
  ...
  return (
    <aside className="" data-id="ogcke45j7" data-path="src/components/Sidebar.tsx">
      <div className='w-64 bg-gray-900 text-white h-screen overflow-y-auto hidden md:flex'>
